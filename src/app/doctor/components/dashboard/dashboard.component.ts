...
@Component({
    ...
    imports: [PaperNoteComponent, FollowersGrowthComponent, TotalUsersComponent, TimelineComponent, PurchaseAccountComponent, RecentSalesComponent, OverallBalanceComponent, RecentOrdersComponent, ActivityComponent, OrdersProfitComponent, ProductStatusChartBoxComponent, WelcomeComponent, BreadcrumbComponent]
})
